...
var Portal = React32.forwardRef(function Portal2(props, ref) {
  ...
  const handleRef = useForkRef(React32.isValidElement(children2) ? children2.ref : null, ref);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
...
var MenuUnstyled = React34.forwardRef(function MenuUnstyled2(props, forwardedRef) {
...
var SelectUnstyled = React45.forwardRef(function SelectUnstyled2(props, forwardedRef) {
...
var SnackbarUnstyled = React49.forwardRef(function SnackbarUnstyled2(props, ref) {
  const {
    autoHideDuration = null,
    children: children2,
    component,
...
var TablePaginationActionsUnstyled = React52.forwardRef(function TablePaginationActionsUnstyled2(props, ref) {
...
var TablePaginationUnstyled = React53.forwardRef(function TablePaginationUnstyled2(props, ref) {
...
var TabsUnstyled = React57.forwardRef(function TabsUnstyled2(props, ref) {
  var _ref;
  const {
    children: children2,
    orientation = "horizontal",
...
var TabPanelUnstyled = React58.forwardRef(function TabPanelUnstyled2(props, ref) {
  var _ref;
  const {
    children: children2,
    component,
...
var TabsListUnstyled = React61.forwardRef(function TabsListUnstyled2(props, ref) {
  var _ref;
  const {
    children: children2,
    component,
...
function Ripple(props) {
  ...
  const [leaving, setLeaving] = React88.useState(false);
...
var TouchRipple = React89.forwardRef(function TouchRipple2(inProps, ref) {
  ...
  const [ripples, setRipples] = React89.useState([]);
  const nextKey = React89.useRef(0);
  const rippleCallback = React89.useRef(null);
  React89.useEffect(() => {
  ...
  const ignoringMouseDown = React89.useRef(false);
  const startTimer = React89.useRef(null);
  const startTimerCommit = React89.useRef(null);
  const container = React89.useRef(null);
  React89.useEffect(() => {
    return () => {
      clearTimeout(startTimer.current);
    };
  }, []);
  const startCommit = React89.useCallback((params) => {
    const {
      pulsate: pulsate2,
      rippleX,
      rippleY,
  ...
  const start2 = React89.useCallback((event = {}, options = {}, cb = () => {
  }) => {
    const {
  ...
  const pulsate = React89.useCallback(() => {
    start2({}, {
      pulsate: true
    });
  }, [start2]);
  const stop = React89.useCallback((event, cb) => {
    clearTimeout(startTimer.current);
  ...
  React89.useImperativeHandle(ref, () => ({
    pulsate,
    start: start2,
    stop
  }), [pulsate, start2, stop]);
...
var ButtonBase = React90.forwardRef(function ButtonBase2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiButtonBase"
  });
  ...
  const rippleRef = React90.useRef(null);
  ...
  const keydownRef = React90.useRef(false);
...
var Button = React92.forwardRef(function Button2(inProps, ref) {
